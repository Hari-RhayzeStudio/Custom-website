      ...
      <div className="bg-white/95 backdrop-blur-md border-b border-gray-100 sticky top-0 z-30 py-4 shadow-sm transition-all w-full">
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20 xl:px-28 flex gap-3 sm:gap-4 items-center w-full">
          ...
          <form onSubmit={handleSearch} className="flex-1 flex gap-2 relative group w-full">
            <div className="relative flex-1 w-full">
                <input 
                  ...
                  className="w-full p-3 pl-12 border border-gray-200 rounded-full bg-gray-50 focus:bg-white focus:border-[#7D3C98] focus:ring-4 focus:ring-purple-50 outline-none transition-all duration-300 placeholder-gray-400 text-gray-800"
                />
          ...
          <button 
            ...
            className={`
              flex items-center gap-2 px-4 sm:px-5 py-3 rounded-full font-medium border transition-all duration-300 relative shrink-0
